<template>
  <div>
    <UiPageHeader title="Anggota Tim" description="Kelola siapa saja yang memiliki akses ke workspace ini.">
      <UiButton v-if="currentUserRole === 'owner' || currentUserRole === 'admin'" @click="isModalOpen = true">
        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z"></path></svg>
        Undang Anggota
      </UiButton>
    </UiPageHeader>

    <UiLoading v-if="loading && members.length === 0" />

    <UiEmptyState
        v-else-if="members.length === 0"
        title="Belum ada anggota"
        description="Anda adalah satu-satunya anggota di sini."
    />
